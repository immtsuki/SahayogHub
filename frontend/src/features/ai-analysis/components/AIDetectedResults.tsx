...
export default function AIDetectedResults({ inline = false }: AIDetectedResultsProps) {
  const content = (
    <>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden">
            <div className="h-full bg-blue-500 rounded-full transition-all duration-700" style={{ width: '75%' }} />
          </div>
        </div>
      </div>
    </>
