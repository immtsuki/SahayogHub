...
export const feedItems: FeedItem[] = [
  {
    id: '1',
    user: { id: 'u1', name: 'Maya Chen', avatar: 'https://i.pravatar.cc/40?img=5' },
    status: 'LOST',
  ...
  {
    id: '2',
    user: { id: 'u2', name: 'Jordan Lee', avatar: 'https://i.pravatar.cc/40?img=8' },
    status: 'FOUND',
  ...
  {
    id: '3',
    user: { id: 'u3', name: 'Daniel Reyes', avatar: 'https://i.pravatar.cc/40?img=12' },
    status: 'LOST',
