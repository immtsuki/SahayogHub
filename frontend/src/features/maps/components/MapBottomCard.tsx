      ...
      {detailOpen && (
        <ItemDetailModal
          item={{
            id: marker.id,
            title: marker.title,
            description: marker.description ?? `${marker.title} reported near ${marker.location ?? marker.distance}.`,
            image: marker.image,
            status: marker.status,
            date: marker.date ?? marker.postedAgo,
            location: marker.location ?? marker.distance,
            lat: marker.lat,
            lng: marker.lng,
            distance: marker.distance,
            postedAgo: marker.postedAgo,
            user: marker.user ?? {
              name: 'Sahayog User',
              avatar: 'https://i.pravatar.cc/40?u=sahayog',
            },
          }}
