...
export function SearchIcon({ active }: IconProps) {
  return (
    <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth={active ? 2.2 : 1.8} viewBox="0 0 24 24" aria-hidden="true">
...
export function NotificationIcon({ active }: IconProps) {
  return active ? (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
